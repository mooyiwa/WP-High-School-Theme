        ...
        <div class="nb-new-settings-wrap">
                            ...
                            <div class="nb-option-field-wrap">
                                ...
                                <div class="nb-option-field">
                                    ...
                                    <div class="nb-slides-append">
                                        <?php
                                        $slide_count = 0;
                                        foreach ( $nb_settings['layout_1']['middle']['slider']['slides'] as $slide ) {
                                            $slide_count++;
                                            ?>
                            ...
                            <div class="nb-option-field-wrap">
                                ...
                                <div class="nb-option-field">
                                    <div class="nb-ticker-append">
                                        <?php
                                        $ticker_count = 0;
                                        foreach ( $nb_settings['layout_1']['middle']['ticker']['ticker_items'] as $ticker ) {
                                            $ticker_count++;
                                            ?>
                                            <div class="nb-each-slide">
            ...
            <div class="nb-display-configurations nb-configurations" style="display:none">
                ...
                <div class="nb-option-field-wrap">
                    ...
                    <div class="nb-option-field">
                        <input type="number" name="nb_settings[display][font_size]"   value="<?php echo esc_attr( $nb_settings['display']['font_size'] ); ?>" min="12"/>
                        <div class="nb-option-note"><?php _e( 'Please enter the font size in px. For example 14px. Default font size is 12px', 'notice-bar' ); ?></div>
                    </div>
                </div>
